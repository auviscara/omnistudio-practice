import { FlexCardMixin } from "omnistudio/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels, loadCssFromStaticResource } from "omnistudio/flexCardUtility";
          ...
          export default class cfBankHomePage_1_Deloitte extends FlexCardMixin(LightningElement){
              @api debug;
              @api recordId;
              @api objectApiName;
        ...
        @api set cfOwnerId(val) {
          if(typeof val !== "undefined") {
            this._sessionApiVars["OwnerId"] = val;
          }
        } get cfOwnerId() {
          return this._sessionApiVars["OwnerId"] || "";
        }
