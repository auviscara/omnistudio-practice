...
import { OMNIDEF } from './bankTransactionsEnglish_def.js';
import tmpl from './bankTransactionsEnglish.html';
import tmpl_nds from './bankTransactionsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bankTransactionsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
