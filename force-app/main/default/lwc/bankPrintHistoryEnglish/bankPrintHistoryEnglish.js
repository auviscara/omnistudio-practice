...
import { OMNIDEF } from './bankPrintHistoryEnglish_def.js';
import tmpl from './bankPrintHistoryEnglish.html';
import tmpl_nds from './bankPrintHistoryEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bankPrintHistoryEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
