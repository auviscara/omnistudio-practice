...
import { OMNIDEF } from './bankTransferEnglish_def.js';
import tmpl from './bankTransferEnglish.html';
import tmpl_nds from './bankTransferEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bankTransferEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
