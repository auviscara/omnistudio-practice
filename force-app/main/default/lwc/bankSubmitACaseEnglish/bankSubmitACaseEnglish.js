...
import { OMNIDEF } from './bankSubmitACaseEnglish_def.js';
import tmpl from './bankSubmitACaseEnglish.html';
import tmpl_nds from './bankSubmitACaseEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bankSubmitACaseEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
