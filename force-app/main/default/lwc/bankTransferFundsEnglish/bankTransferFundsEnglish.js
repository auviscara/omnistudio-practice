...
import { OMNIDEF } from './bankTransferFundsEnglish_def.js';
import tmpl from './bankTransferFundsEnglish.html';
import tmpl_nds from './bankTransferFundsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bankTransferFundsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
