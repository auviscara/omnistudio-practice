...
import { OMNIDEF } from './bankUpdateLabelEnglish_def.js';
import tmpl from './bankUpdateLabelEnglish.html';
import tmpl_nds from './bankUpdateLabelEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class bankUpdateLabelEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
