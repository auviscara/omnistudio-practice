import { FlexCardMixin } from "omnistudio/flexCardMixin";
    import {interpolateWithRegex, interpolateKeyValue, fetchCustomLabels, loadCssFromStaticResource } from "omnistudio/flexCardUtility";
          ...
          export default class cfBankTransferFunds_1_Deloitte extends FlexCardMixin(LightningElement){
              @api debug;
              @api recordId;
              @api objectApiName;
        ...
        @api set cfEmailAddress(val) {
          if(typeof val !== "undefined") {
            this._sessionApiVars["EmailAddress"] = val;
          }
        } get cfEmailAddress() {
          return this._sessionApiVars["EmailAddress"] || "";
        }
